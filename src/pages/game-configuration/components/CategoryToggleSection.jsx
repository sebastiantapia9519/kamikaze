...
/**
 * Componente que muestra una lista de categorías de retos (Regular, Épico, Multijugador)
 * y permite al usuario activarlas o desactivarlas.
 * 
 * @param {Object} props
 * @param {Object} props.categories - Objeto con el estado actual de las categorías (ej. { regular: true, epic: false }).
 * @param {Function} props.onCategoryChange - Función callback que recibe el id de la categoría y su nuevo estado booleano.
 */
const CategoryToggleSection = ({ categories, onCategoryChange }) => {
    // Definimos las opciones con colores vibrantes para que resalten sobre el fondo oscuro

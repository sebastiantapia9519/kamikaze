...
/**
 * Componente para ajustar configuraciones específicas del juego como la duración,
 * el orden de turnos y habilitar características adicionales (sonidos, vibración, etc.).
 * 
 * @param {Object} props
 * @param {Object} props.settings - Objeto con los ajustes actuales.
 * @param {Function} props.onSettingChange - Callback que recibe la clave del ajuste modificado y su nuevo valor.
 */
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-white/10">
                    ...
                    <div className="space-y-3">
                        {/* Temporizador (Actualmente oculto por diseño) */}

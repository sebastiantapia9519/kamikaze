            ...
            <AnimatePresence>
                {phase === 'RESULTS' && (
                    ...
                    >
                        {/* --- SECCIÓN DEL GANADOR --- */}
                        {(() => {
                            // Encontramos la info del ganador
                            ...
                            return (
                                <div className="text-center mb-8">
                                    ...
                                    <h2
                                        ...
                                        style={{
                                            color: winningAxolotlInfo?.hex || 'white',
                                            textShadow: `0 0 25px ${winningAxolotlInfo?.hex}60` // Añadido un resplandor del mismo color
                                        }}
                                    >
                                        🏆 {winningAxolotlInfo?.name} 🏆
                                    </h2>
                                </div>
                            );
                        })()}
